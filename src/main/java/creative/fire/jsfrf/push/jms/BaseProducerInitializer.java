 ...
 *
 */
public abstract class BaseProducerInitializer extends BaseInitializer {

    private Thread messageProducerThread;
    private JMSProducer messageProducer;
    private ProducerRunnable messageProducerRunnable;
 
    public void initializeCapability() {
        messageProducer = createMessageProducer();
        messageProducerRunnable = new ProducerRunnable(messageProducer);
    ...
    public abstract JMSProducer createMessageProducer();
}
